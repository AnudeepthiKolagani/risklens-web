    ...
    <div
      ...
      className={`cursor-pointer rounded-sm border-2 border-dashed px-6 py-10 text-center transition-colors ${
        isDragActive
          ...
          : "border-cyan-400/20 bg-black/20 hover:border-cyan-400/40"
      }`}
    >
      <input {...getInputProps()} />
      <Upload className="mx-auto h-8 w-8 text-slate-500" />
      <p className="mt-3 text-md font-medium text-slate-200">
      ...
      <Button
        ...
        className="mt-4 rounded-2xl border border-cyan-400/40 bg-cyan-400/10 text-xs font-semibold uppercase tracking-wider text-cyan-400 hover:bg-cyan-400/20"
      >
